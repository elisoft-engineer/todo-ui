...
class _TaskListState extends State<TaskList> {
  ...
  void initState() {
    super.initState();
    tasksFutureNotifier.value = _fetchTasks();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<Future<List<Task>>>(
      valueListenable: tasksFutureNotifier,
      builder:
          (context, tasksFuture, child) => FutureBuilder<List<Task>>(
            future: tasksFuture,
                                ...
                                trailing: GestureDetector(
                                  onTap: () {
                                    showDialog(
                                      context: context,
                                      builder:
                                          (context) => TaskEditForm(task: task),
                                    );
                                  },
                                  child: Container(
                                    width: 32,
